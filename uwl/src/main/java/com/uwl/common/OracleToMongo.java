...
public class OracleToMongo {
	public static void main(String[] args) {
		...
		MongoDatabase mongoDB = mongoConn.getDatabase("minicord");
		...
		try {
			...
			while(rs.next()) {
				...
				// 잘나오는지 확인2
				System.out.println(gender+"|"+userId+"|"+userName+"|"+nickName+"|"+fileName);
//				
...
//				
				...
				Bson update = new Document("$set", new
						...
						.append("online", true)
						.append("email", email)
						.append("profile_picture", "/img/placeholder.png")
