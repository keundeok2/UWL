                                ...
                                <c:forEach var="reward" items="${list}">
                                    ...
                                    <div class="row">
                                        ...
                                        <i class="fas fa-coins col-sm-4" style="font-size: 25px; text-align: center;">
                                            <font size="4px" color="black"> + ${reward.variablePoint} &emsp;<i class="fas fa-running"></i> + ${reward.variableActivityPoint} </font>
                                        </i>

                                        <i class="fas fa-piggy-bank col-sm-3" style="font-size: 25px; text-align: center;">
                                            <font size="4px" ; color="black" ;> ${reward.totalPoint}</font>
                                        </i>
                                        <i class="far fa-calendar-check col-sm-3" style="font-size: 25px; text-align: left;">
                                            <font size="3px" ; color="black" ;> ${reward.variableDate}</font>
                                        </i>
                                    </div>
                                </c:forEach>
                            </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                <c:forEach var="purchase" items="${purchaseList}">
                                    ...
                                    <div class="row">
                                        ...
                                        <i class="fas fa-coins col-sm-3" style="font-size: 25px; text-align: center;">
                                        ...
                                        <i class="far fa-calendar-check col-sm-3" style="font-size: 25px; text-align: left;">
                                            <font size="3px" ; color="black" ;> ${purchase.variableDate}</font>
                                        </i>
                                    </div>
                                </c:forEach>
                            </div>
