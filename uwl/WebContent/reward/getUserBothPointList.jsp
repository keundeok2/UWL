			    ...
			    <div class="thumbnail">
			      ...
			      <div class="caption">
			        ...
			        <h3>${reward.challenge.challTitle} </h3>
			        	<p>	
			        	<c:if test=" ${!empty reward.purchaseItem.purchaseNo}">
			        		<c:if test=" ${fn:trim(reward.purchaseItem.itemCategory) == '1'}">
			        			구매아이템 : 창<br/>
			        		</c:if>
			        		<c:if test=" ${fn:trim(reward.purchaseItem.itemCategory) == '2'}">
			        			구매아이템 : 방패<br/>
			        		</c:if>
			        	...
			        	<p>	
			        	<c:if test=" ${!empty reward.purchaseItem.itemCategory&& reward.purchaseItem.itemCategory eq '1'}">
			        			구매아이템 : 방패<br/>
			        		</c:if>
			        	구매번호 : ${reward.purchaseItem.purchaseNo}<br>
			        	포인트 : ${reward.variablePoint}<br/>
